...
| **M1** RAG core (English) | next | Ingestion, pgvector retrieval, streamed **cited** answers, safety policy, eval |
| **M2** Multilingual (8 langs) | | UI catalogs + cross-lingual retrieval + native-speaker QA |
