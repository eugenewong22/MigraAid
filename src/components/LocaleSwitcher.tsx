...
import { LOCALE_LABELS, LOCALE_LABELS_SHORT } from "@/i18n/labels";
 ...
 * accessible name. Abbreviates to a short native-script code on mobile.
 */
    ...
    <div className="relative inline-flex">
      ...
      >
        <span className="sm:hidden">
          {LOCALE_LABELS_SHORT[locale] ?? locale.slice(0, 2).toUpperCase()}
        </span>
